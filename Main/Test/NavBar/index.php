                ...
                <div class="nav__content bd-grid">
                    ...
                    <div class="nav__menu">
                        <ul class="nav__list">
                            ...
                            <li class="nav__item"><a href="Main\Chat\index.php" class="nav__link">CHAT</a></li>
                            <li class="nav__item"><a href="Main\Artículos\index.php" class="nav__link">NOTICIAS</a></li>
                        </ul>
                    </div>
